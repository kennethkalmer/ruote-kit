...
describe 'json helper' do
  ...
  describe 'rendering defaults' do
    ...
    it 'should link to the processes' do
      ...
      @hash['links'].detect { |l|
        l['rel'] =~ /#processes$/ && l['href'] == '/_ruote/processes'
      }.should_not be_nil
    end
    ...
    it 'should not link to the expressions by default' do
      ...
      @hash['links'].detect { |l|
        l['rel'] =~ /#expressions$/ && l['href'] == '/_ruote/expressions'
      }.should be_nil
    end
    ...
    it 'should link to the workitems' do
      ...
      @hash['links'].detect { |l|
        l['rel'] =~ /#workitems$/ && l['href'] == '/_ruote/workitems'
      }.should_not be_nil
    end
  end
  ...
  describe 'rendering processes' do
    ...
    describe 'in detail, and' do
      ...
      it 'should link to the process details' do
        ...
        @process['links'].detect { |l|
          l['rel'] =~ /self/ && l['href'] == "/_ruote/processes/#{@wfid}"
        }.should_not be_nil
      end
      ...
      it 'should link to the process expressions' do
        ...
        @process['links'].detect { |l|
          l['rel'] =~ /#process_expressions/ &&
          l['href'] == "/_ruote/expressions/#{@wfid}"
        }.should_not be_nil
      end
      ...
      it 'should link to the process workitems' do
        ...
        @process['links'].detect { |l|
          l['rel'] =~ /#process_workitems/ &&
          l['href'] == "/_ruote/workitems/#{@wfid}"
        }.should_not be_nil
      end
    end
  ...
  describe 'render a single expression' do
    ...
    it 'should link to the process' do
      ...
      @hash['expression']['links'].detect { |l|
        l['rel'] =~ /#process/ && l['href'] == "/_ruote/processes/#{@wfid}"
      }.should_not be_nil
    end
    ...
    it 'should link to the parent expression' do
      ...
      @hash['expression']['links'].detect { |l|
        l['rel'] == 'parent' && l['href'] == "/_ruote/expressions/#{@wfid}/0_0"
      }.should_not be_nil
    end
  end
