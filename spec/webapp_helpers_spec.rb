  ...
  describe 'alink()' do
    ...
    it 'link to top resources' do
      ...
      alink(:processes).should ==
        '<a href="/_ruote/processes" title="/_ruote/processes" rel="http://ruote.rubyforge.org/rels.html#processes">/_ruote/processes</a>'
    end

    it 'should link to identified resources' do

      alink(:processes, '20120808-tokushima').should ==
        '<a href="/_ruote/processes/20120808-tokushima" title="/_ruote/processes/20120808-tokushima" rel="http://ruote.rubyforge.org/rels.html#process">/_ruote/processes/20120808-tokushima</a>'
    end

    it 'should accept a custom :text' do

      alink(:processes, :text => 'processes').should ==
        '<a href="/_ruote/processes" title="/_ruote/processes" rel="http://ruote.rubyforge.org/rels.html#processes">processes</a>'
    end

    it 'should aggregate non-:text options into the query string' do

      alink(:processes, :skip => 3, :limit => 4).should ==
        '<a href="/_ruote/processes?limit=4&skip=3" title="/_ruote/processes?limit=4&skip=3" rel="http://ruote.rubyforge.org/rels.html#processes">/_ruote/processes</a>'
    end
